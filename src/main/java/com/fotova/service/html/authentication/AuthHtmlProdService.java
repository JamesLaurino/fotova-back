...
@Service
@Profile("prod")
public class AuthHtmlProdService implements AuthHtmlService {
    ...
    public String buildSuccessResetPassword() {
        ...
        <!DOCTYPE html>
                    ...
                    <meta http-equiv="refresh" content="5;url=https://82.29.172.74/login">
                    <style>
                        body {
                    ...
                    <div class="card">
                        ...
                        <a href="https://82.29.172.74/login">
                    ...
                    <script>
                        ...
                        const interval = setInterval(() => {
                            ...
                            if(seconds <= 0) {
                                ...
                                window.location.href = "https://82.29.172.74/login";
                            }
                        }, 1000);
                    </script>
                    </body>
